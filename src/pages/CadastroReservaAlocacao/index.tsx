...
export const CadastroReservaAlocacao: React.FC = () => {
    ...
    const { createReservaAlocacao, updateReservaAlocacao } = useContext(
        ReservaAlocacaoContext
    );
            ...
            >
                ...
                >
                    <Typography fontSize="25px" color="primary">
                        {!isEdicao
                            ? "Cadastro de Reserva e Alocação"
                            : "Editar Cadastro de Reserva e Alocação"}
                    </Typography>
                </Box>
                <Box
                    component="form"
                    id="form"
                    onSubmit={handleSubmit((data: TReservaAlocacao) => {
                ...
                >
                    ...
                    >
                        <TextField
                            ...
                            id="idReservaAlocacao"
                            {...register("idReservaAlocacao")}
                            variant="outlined"
                            label="Código"
                            ...
                            helperText={
                                errors.idReservaAlocacao && errors.idReservaAlocacao.message
                                    ? errors.idReservaAlocacao.message
                                    : null
                            }
                            error={Boolean(
                                errors.idReservaAlocacao && errors.idReservaAlocacao.message
                    ...
                    >
                        <TextField
                            ...
                            helperText={
                                errors.idAluno && errors.idAluno.message
                                    ? errors.idAluno.message
                                    : null
                            }
                        ...
                        <TextField
                            ...
                            InputProps={{ inputProps: { min: 1 } }}
                            helperText={
                                errors.idVaga && errors.idVaga.message
                                    ? errors.idVaga.message
                                    : null
                            }
                    ...
                    >
                        <TextField
                            ...
                            InputProps={{ inputProps: { min: 1 } }}
                            helperText={
                                errors.idAvaliacao && errors.idAvaliacao.message
                                    ? errors.idAvaliacao.message
                                    : null
                            }
                    ...
                    >
                        ...
                        >
                            ...
                            <TextField
                                ...
                                helperText={
                                    errors.dataReserva && errors.dataReserva.message
                                        ? errors.dataReserva.message
                                        : null
                                }
                                error={Boolean(
                                    errors.dataReserva && errors.dataReserva.message
                    ...
                    >
                        <FormControl fullWidth>
                            <FormLabel htmlFor="dataCancelamento">
                        ...
                        <FormControl fullWidth>
                            <FormLabel htmlFor="dataFinalizacao">
                                Data de Finalização
                            </FormLabel>
                            <TextField
                                type="date"
                    ...
                    >
                        <FormControl fullWidth>
                            ...
                            <Select
                                id="statusAluno"
                                defaultValue={isEdicao ? state.statusAluno : "RESERVADO"}
                                size="small"
                                {...register("statusAluno")}
                            >
                                <MenuItem value="RESERVADO" sx={{ height: "30px" }}>
                                    Reservado
                                </MenuItem>
                                <MenuItem value="ALOCADO" sx={{ height: "30px" }}>
                                    Alocado
                                </MenuItem>
                    ...
                    >
                        <Box sx={{ textAlign: "center" }}>
                            <Button
                                variant="contained"
                                onClick={() => navigate("/reservas-alocacoes")}
                                sx={{
                                    height: "50px",
                                }}
                            >
