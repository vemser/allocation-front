      ...
      >
        ...
        >
          <Typography fontSize="25px" color="primary">
            {state != null ? "Editar Vaga" : "Cadastro de Vaga"}
          </Typography>
        </Box>
        <Box
          component="form"
          id="form"
          onSubmit={handleSubmit((data: IVagaForm) => {
            state != null
              ? updateVaga(data, state.idVaga, state.dataCriacao)
              : createVaga(data);
          })}
          sx={{
            display: "flex",
        ...
        >
          ...
          >
            ...
            <TextField
              ...
              helperText={
                errors.idPrograma && errors.idPrograma
          ...
          >
            ...
            <TextField
              type="number"
              placeholder="Quantidade de Alocados"
              id="quantidadeAlocados"
              {...register("quantidadeAlocados")}
              variant="outlined"
          ...
          <Box sx={{
            ...
            <FormControl
              fullWidth
              error={Boolean(errors.observacoes && errors.observacoes.message)}
            >
              <FormLabel htmlFor="observacoes">
                {errors.observacoes
