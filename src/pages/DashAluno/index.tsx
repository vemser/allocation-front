...
export const DashAluno = () => {
    ...
    const { alunos, deleteAluno, getAlunos }= useContext(AlunoContext);
      ...
      margin: '30px'    
            ...
            <Box sx={{
                ...
                sx={{
                    ...
                    <TextField type="text" placeholder='Digite o nome do Aluno' id='pesquisa' {...register('pesquisa')} variant="outlined"
                    label="Pesquisar"
                    InputProps={{
                        startAdornment: (
