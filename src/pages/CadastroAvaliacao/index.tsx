...
import {
    avaliacaoEntrevistaFormSchema,
    avaliacaoSimplesFormSchema,
} from "../../util/schemas";
        ...
        >
            ...
            >
                ...
                <Box
                    component="form"
                    id="form"
                    onSubmit={handleSubmit((data: TAvaliacao) => {
                ...
                >
                    ...
                    >
                        <TextField
                            ...
                            helperText={
                                errors.emailAluno && errors.emailAluno.message
                                    ? errors.emailAluno.message
                                    : null
                            }
                        ...
                        <TextField
                            ...
                            {...register("idVaga")}
                            helperText={
                                errors.idVaga && errors.idVaga ? errors.idVaga.message : null
                            }
                    ...
                    >
                        ...
                        <TextField
                            ...
                            helperText={
                                errors.nota && errors.nota.message ? errors.nota.message : null
                            }
                    ...
                    >
                        <FormControl
                            fullWidth
                            error={Boolean(
                                errors.dataAvaliacao && errors.dataAvaliacao.message
                            )}
                        >
                        ...
                        <FormControl fullWidth>
                            ...
                            >
                                <MenuItem value="INDIVIDUAL" sx={{ height: "30px" }}>
                                    Individual
                                </MenuItem>
                                <MenuItem value="CLIENTE" sx={{ height: "30px" }}>
                                    Cliente
                                </MenuItem>
                            </Select>
                        </FormControl>
                    ...
                    >
                        <FormControl
                            fullWidth
                            error={Boolean(
                                errors.dataEntrevistaGp && errors.dataEntrevistaGp.message
                            )}
                        >
                            <FormLabel htmlFor="dataEntrevistaGp">
                                Data de Entrevista GP
                            </FormLabel>
                            <TextField
                                type="date"
                                id="dataEntrevistaGp"
                                ...
                                helperText={
                                    errors.dataEntrevistaGp && errors.dataEntrevistaGp.message
                                        ? errors.dataEntrevistaGp.message
                                        : null
                                }
                                error={Boolean(
                                    errors.dataEntrevistaGp && errors.dataEntrevistaGp.message
                        ...
                        <FormControl
                            fullWidth
                            error={Boolean(
                                errors.dataEntrevistaCliente &&
                                errors.dataEntrevistaCliente.message
                            )}
                        >
                            <FormLabel htmlFor="dataEntrevistaCliente">
                                Data de Entrevista Cliente
                            </FormLabel>
                            <TextField
                                type="date"
                                ...
                                disabled={tipo === "simples"}
                                defaultValue={
                                    isEdicao ? state.dataEntrevistaCliente : undefined
                                }
                    ...
                    >
                        ...
                        <FormControl fullWidth>
                            ...
                            <Select
                                ...
                                {...register("situacao")}
                            >
                                <MenuItem value="AVALIADO" sx={{ height: "30px" }}>
                                    Avaliado
                                </MenuItem>
                                <MenuItem
                                    disabled={tipo === "simples"}
                                ...
                                <MenuItem
                                    disabled={tipo === "simples"}
                                    value="ENTREVISTADO_CLIENTE"
                                    sx={{ height: "30px" }}
                                >
                                    Entrevistado Cliente
                                </MenuItem>
                                <MenuItem
                                    disabled={tipo === "simples"}
                                    value="APROVADO"
