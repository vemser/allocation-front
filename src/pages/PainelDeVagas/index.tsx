...
export const PainelDeVagas = () => {
  ...
  const { deleteVaga, totalPages, vagas, getPesquisaIdVagas, getVagas } =
              ...
              {vagas.length === 0 || vagas == null ? (
                ...
                vagas.map((el: any) => (
                  <Box
                    sx={{
                      background:
                        el.quantidade - el.quantidadeAlocados > 0
                          ? '#D9D9D9'
                          : '#d76969',
                      color:
                        el.quantidade - el.quantidadeAlocados > 0
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        ...
                        {el.quantidade - el.quantidadeAlocados >= 0
                          ? el.quantidade - el.quantidadeAlocados
                          : '0'}{' '}
                        vaga
                        {el.quantidade - el.quantidadeAlocados > 1 ? 's' : ''}
                      </Typography>
                      <Typography
                        sx={{ fontSize: '12px', wordWrap: 'break-word' }}
                      >
